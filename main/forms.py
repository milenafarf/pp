...
class ProjectRegisterForm(forms.Form):
    ...
    funding_goal=forms.IntegerField(label='Oczekiwana kwota wsparcia', widget=forms.NumberInput(attrs={'class': 'form-control','style': 'width: 500px', 'min': '0', 'max': '1000000', 'step': '1','type':'range','value':'0','onmousemove': 'valuechange()'}))
...
class ProjectPerks(forms.Form):
    ...
    perk_value=forms.IntegerField(label='Oczekiwana kwota wsparcia', widget=forms.NumberInput(attrs={'class': 'form-control','min':'0','style': 'width: 500px','max': '1000000', 'step': '1','type':'range','value':'0','onmousemove': 'perkvaluechange()'}))
